...
def create_form_field_button(field_name, link):
    if field_name:
        ...
        def display_field_modal_inputs():
            ...
            properties = field_form.find_element(By.ID, "properties")
            form_groups = properties.find_elements(By.XPATH, "div[contains(@class, 'form-group is-ic-field')]")
            ...
            for form_group in form_groups:
                ...
                Label_field.pack()
                created_widgets.append(Label_field)

                entry_field = tk.Entry(tab_frame)
                entry_field.pack()
                created_widgets.append(entry_field)
...
def handle_edit_form():
    driver.find_element(By.XPATH, "//a[contains(@name, 'edit_fields_link')]").click()
